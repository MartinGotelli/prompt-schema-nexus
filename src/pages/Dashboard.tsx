...
import CreateSchemaDialog from "@/components/schema/CreateSchemaDialog";
  ...
  return (
    <div className="space-y-6">
      ...
      <CreateSchemaDialog 
        ...
        onOpenChange={setIsCreateSchemaOpen}
            ...
            <div className="space-y-4">
              {Object.entries(countByStatus).map(([status, count]) => (
                <div key={status} className="flex items-center justify-between">
                  ...
                  <div className="ml-auto font-bold">{count} items</div>
                </div>
              ))}
              ...
              <div className="mt-2 text-right">
                <Button variant="link" size="sm" asChild>
                  <Link to="/schemas">View all schemas</Link>
                </Button>
              </div>
            </div>
          </CardContent>
